...
### Changed
- feat(bun): single-file mode for markdown-di-typegen ([#19](https://github.com/PepijnSenders/markdown-di/pull/19)) by @PepijnSenders


## [0.9.15] - 2026-07-04

### Changed
- Strict rendering, /batch/validator fixes, and @markdown-di/bun typed imports ([#18](https://github.com/PepijnSenders/markdown-di/pull/18)) by @PepijnSenders


## [0.9.14] - 2025-10-29

### Changed
- feat: simplify validation error handling and improve error accessibility ([#17](https://github.com/PepijnSenders/markdown-di/pull/17)) by @PepijnSenders


## [0.9.13] - 2025-10-27

### Changed
- revert: remove Bun catalogs and return to npm publish ([#16](https://github.com/PepijnSenders/markdown-di/pull/16)) by @PepijnSenders


## [0.9.12] - 2025-10-27

### Changed
- fix: use bun pack + npm publish to resolve catalog auth issue ([#15](https://github.com/PepijnSenders/markdown-di/pull/15)) by @PepijnSenders


## [0.9.11] - 2025-10-27

### Changed
- fix: add npm whoami verification and complete .npmrc config ([#14](https://github.com/PepijnSenders/markdown-di/pull/14)) by @PepijnSenders


## [0.9.10] - 2025-10-27

### Changed
- fix: create .npmrc in packages/core directory for bun publish ([#13](https://github.com/PepijnSenders/markdown-di/pull/13)) by @PepijnSenders


## [0.9.9] - 2025-10-27

### Changed
- fix: use NPM_CONFIG_TOKEN for bun publish authentication ([#12](https://github.com/PepijnSenders/markdown-di/pull/12)) by @PepijnSenders


## [0.9.8] - 2025-10-27

### Changed
- fix: use npm config env var for bun publish authentication ([#11](https://github.com/PepijnSenders/markdown-di/pull/11)) by @PepijnSenders


## [0.9.7] - 2025-10-27

### Changed
- fix: create .npmrc in multiple locations for bun publish ([#9](https://github.com/PepijnSenders/markdown-di/pull/9)) by @PepijnSenders
